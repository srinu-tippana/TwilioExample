...
import com.enhance.twilio.dto.OtpStatus;
import com.enhance.twilio.dto.PasswordResetRequestDto;
import com.enhance.twilio.dto.PasswordResetResponseDto;
...
public class TwilioOTPService {
    ...
    public Mono<PasswordResetResponseDto> sendOTPForPasswordReset(PasswordResetRequestDto passwordResetRequestDto) {
        ...
        try {
            ...
            String otpMessage = "Bro Test for the otp  , Your OTP is ##" + otp + "  ##. Use this Passcode to complete your transaction. Thank You.";
